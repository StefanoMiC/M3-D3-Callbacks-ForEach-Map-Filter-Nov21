...
const somethingElse = (str, num) => console.log(str + " Whatever else " + num + " ");
...
const animals = ["cat", "dog", "mouse", "rabbit", "horse", "snake", "spider", "goldfish", "monkey"];
...
const displayAnimalWithName = (animalType, name) => {
  console.log("We found a " + animalType + " and it's going to be called " + name);
};
